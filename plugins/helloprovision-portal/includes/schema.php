	...
	$entities = array(
		'client'       => array(
			...
			'fields'   => array(
				...
				// Értékesítés (includes/sales.php kezeli, az ügyfél-űrlapokon nem jelenik meg).
				'lead_stage'       => array( 'type' => 'select', 'label' => 'Értékesítési szakasz', 'readonly' => true, 'hidden' => true, 'default' => '', 'options' => array( '' => array( '—', '—' ), 'new' => array( 'Új', 'New' ), 'contacted' => array( 'Felvettük a kapcsolatot', 'Contacted' ), 'qualified' => array( 'Igényfelmérés', 'Qualified' ), 'proposal' => array( 'Ajánlat kint', 'Proposal' ), 'won' => array( 'Megnyert', 'Won' ), 'lost' => array( 'Elveszett', 'Lost' ) ) ),
				'lead_source'      => array( 'type' => 'text', 'label' => 'Honnan jött (űrlap)', 'readonly' => true, 'hidden' => true ),
				'lead_channel'     => array( 'type' => 'text', 'label' => 'Csatorna', 'readonly' => true, 'hidden' => true ),
				'lead_campaign'    => array( 'type' => 'text', 'label' => 'Kampány', 'readonly' => true, 'hidden' => true ),
				'lead_attribution' => array( 'type' => 'textarea', 'label' => 'Forrásadatok (JSON)', 'readonly' => true, 'hidden' => true ),
				'lead_owner'       => array( 'type' => 'ref', 'ref' => 'user', 'label' => 'Felelős', 'readonly' => true, 'hidden' => true ),
				'lead_value'       => array( 'type' => 'money', 'label' => 'Becsült érték', 'readonly' => true, 'hidden' => true ),
				'next_step'        => array( 'type' => 'text', 'label' => 'Következő lépés', 'readonly' => true, 'hidden' => true ),
				'next_step_date'   => array( 'type' => 'date', 'label' => 'Következő lépés napja', 'readonly' => true, 'hidden' => true ),
				'lost_reason'      => array( 'type' => 'text', 'label' => 'Miért veszett el', 'readonly' => true, 'hidden' => true ),
				'lead_at'          => array( 'type' => 'datetime', 'label' => 'Érdeklődés', 'readonly' => true, 'hidden' => true ),
				'first_contact_at' => array( 'type' => 'datetime', 'label' => 'Első válasz', 'readonly' => true, 'hidden' => true ),
				'won_at'           => array( 'type' => 'datetime', 'label' => 'Megnyerve', 'readonly' => true, 'hidden' => true ),
				'lost_at'          => array( 'type' => 'datetime', 'label' => 'Elveszett', 'readonly' => true, 'hidden' => true ),
				'sla_reminded_at'  => array( 'type' => 'datetime', 'label' => 'Válaszidő-figyelmeztetés', 'readonly' => true, 'hidden' => true ),
			),
		),
